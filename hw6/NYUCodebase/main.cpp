...
int main(int argc, char *argv[])
{
	...
	Mix_Chunk *chewy;
	Mix_Chunk *OH;
	bg_music = Mix_LoadMUS("DOOM 2016 OST - BFG Division.mp3");
	chewy = Mix_LoadWAV("chewy_roar.wav");
	OH = Mix_LoadWAV("OH Sound effect.wav");
#ifdef _WINDOWS
	glewInit();
#endif
